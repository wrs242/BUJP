...
<head>
    ...
    <title>Portal Keamanan | Data Rekrutmen</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Rekrutmen</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><a href="{{ url('entry-rekrutmen') }}"><button type="button"
                                        class="btn btn-block btn-primary">Tambah Rekrutmen Baru</button></a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Alamat</th>
                                        <th>No. Telp</th>
                                        <th>Tanggal Terima Company Profile</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$rekrutmen->NAMA_BUJP}}</td>
                                        <td>{{$rekrutmen->ALAMAT}}</td>
                                        <td>{{$rekrutmen->TELP_KANTOR}}</td>
                                        <td>{{$rekrutmen->TGL_TERIMA_COMPANY_PROFILE}}</td>
                                        <td>{{$rekrutmen->UNDANGAN_PRESENTASI}}</td>
                                        <td>{{$rekrutmen->TGL_PRESENTASI}}</td>
                                        <td>{{$rekrutmen->HASIL_SELEKSI}}</td>
                                        <td>
                                            <a href="{{$rekrutmen->ID_BUJP}}/detail-rekrutmen"><button
                                                    class="btn btn-block btn-secondary">Detail</button></a>
                                        </td>
                                    </tr>
                                    @endforeach
                            </table>
