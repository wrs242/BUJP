...
<head>
  ...
  <title>Portal Keamanan | Data Form Kontrol</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Form Kontrol Operasional</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><a href="{{ url('tambah-kontrol-bulanan') }}"><button type="button" class="btn btn-block btn-primary">Tambah Kontrol Bulanan</button></a></h3>
