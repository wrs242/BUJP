...
<head>
    ...
    <title>Portal Keamanan | Data Stakeholder Wilayah</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Stakeholder Wilayah</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ url('entry-stakeholder') }}"><button type="button"
                                            class="btn btn-block btn-primary">Tambah Stakeholder</button></a></h3>
                            </div>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{$stakeholder->ID_STAKEHOLDER}}/detail-stakeholder"><button
