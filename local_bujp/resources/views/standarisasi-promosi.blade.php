        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <label h1 class="m-1">Standariasi Promosi</h1>
                            </label>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <label h3 class="card-title">Kriteria Promosi KARU</h3>
                                        <label>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div for="teks">1.Penilaian Kedisiplinan ( absensi ) baik & tidak ada
                                                pelanggaran
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label sidebar-dark-primary for="teks3">( Interview dgn KABAG PAM )
                                        ...
                                        <div class="form-group">
                                            <div for="teks3">5.Loyalitas & kepedulian atau jiwa korps dan kesatuan
                                                (KORSA)
                                            </div>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <label h3 class="card-title">Kriteria Promosi WAKASI & KASI </h3>
                                        <label>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <div for="teks3">3.Memahami tugas pokok (track record/rapport penugasan yg
                                                teridentifikasi)
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label sidebar-dark-primary for="teks3">6.Promosi dari WAKASI ke KASI :
                                                Project Improvement utk karyawan Back Office (Admin)
                                            </label sidebar-dark-primary>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-warning">
                                <div class="card-header">
                                    <label h3 class="card-title">Kriteria Promosi Section Head </h3>
                                        <label>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label sidebar-dark-primary for="teks3">3.(Interview dgn Security Asst. Dir)
                                            </label sidebar-dark-primary>
                                        </div>
                                        <div class="form-group">
                                            <label sidebar-dark-primary for="teks3">4.Sudah pernah rotasi di beberapa
                                                unit bisnis (min. 2 unit bisnis, bisa berbeda atau sama)
                                            </label sidebar-dark-primary>
                                        </div>
                                        <div class="form-group">
                                            <label sidebar-dark-primary for="teks3">5.Assessment Behavior
                                            </label sidebar-dark-primary>
                                        </div>
