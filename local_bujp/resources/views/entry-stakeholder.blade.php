                    ...
                    <div class="card-body">
                        ...
                        <form action="/entry-stakeholder" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="KAWASAN" placeholder="Kawasan"
                                            required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-sm-6">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        name="MULAI_MENJABAT_P_LAMA">
                                                </div>
                                                <div class="form-group col-sm-6">
                                                    <label>Akhir</label>
                                                    <input type="date" class="form-control"
                                                        name="AKHIR_MENJABAT_P_LAMA">
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Jumlah Personel"
                                                name="JUMLAH_PERSONEL_P_BARU" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Tahun Angkatan"
                                                name="TAHUN_ANGKATAN_P_BARU" required>
                                        </div>
                                    </td>
                                    <td class="col-3">
                                        <input type="file" placeholder="Upload Foto" name="FOTO_P_BARU" id="FOTO_P_BARU"
                            ...
                            <div class="card-footer">
                                ...
                                <a href="/stakeholder"><button type="button"
