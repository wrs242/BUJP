                ...
                <form action="/store-edit-stakeholder" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="KAWASAN" placeholder="Wilayah" value="{{$stakeholder->KAWASAN}}" required>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Wilayah <span style="color: red">*</span></label>
                        <input type="text" class="form-control" placeholder="Wilayah" name="WILAYAH" value="{{$stakeholder->WILAYAH}}" required>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="Instansi" name="INSTANSI" value="{{$stakeholder->INSTANSI}}">
                          </div>
                          <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="Wilayah Hukum Instansi" name="WILAYAH_HUKUM" value="{{$stakeholder->WILAYAH_HUKUM}}">
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="2" placeholder="Alamat" name="ALAMAT_INSTANSI"  required>{{$stakeholder->ALAMAT_INSTANSI}}</textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <table class="table table-borderless m-0 p-0">
                    ...
                    <tr>
                      <td class="col-3"><div class="form-group">
                        ...
                        <div class="form-group col-sm-6">
                          <label>Awal</label>
                        <input type="date" class="form-control" name="MULAI_MENJABAT_P_LAMA" value="{{$stakeholder->MULAI_MENJABAT_P_LAMA}}">
                        </div>
                        <div class="form-group col-sm-6">
                          <label>Akhir</label>
                        <input type="date" class="form-control" name="AKHIR_MENJABAT_P_LAMA" value="{{$stakeholder->AKHIR_MENJABAT_P_LAMA}}">
                          </div>
                        </div>
                      </div></td>
                      <td class="col-3"><div class="form-group">
                    ...
                    <tr>
                      <td class="col-3"><div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Lokasi Tugas Baru" name="LOKASI_TUGAS_BARU_P_LAMA" value="{{$stakeholder->LOKASI_TUGAS_BARU_P_LAMA}}">
                      </div></td>
                      <td class="col-3"><div class="form-group">
                    ...
                    <tr>
                      <td class="col-3"><div class="form-group">
                        <label>No. Telp</label>
                        <input type="text" class="form-control" placeholder="No. Telp" name="TELP_P_LAMA" value="{{$stakeholder->TELP_P_LAMA}}">
                      </div></td>
                      <td class="col-3"></td>
                      <td class="col-3"><div class="form-group">
                        <label>No. Telp</label>
