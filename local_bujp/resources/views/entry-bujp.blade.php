                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4 nama-bujp" style="width: 100%;"
                                        name="NAMA_BUJP" required>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Objek Pengamanan"
                                        name="OBJEK_PENGAMANAN" required>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Keterangan Status"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step=".01" min="0" class="form-control"
                                            name="TAKE_HOME_PAY_PERSEN" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control telp-kantor" placeholder="No. Telp"
                                        name="TELP_KANTOR">
                                </div>
                            </div>
                        </div>
