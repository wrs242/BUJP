                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td class="col-2">: {{$stakeholder->MULAI_MENJABAT_P_LAMA}} -
                                    {{$stakeholder->AKHIR_MENJABAT_P_LAMA}}</td>
                                <td class="col-1">Periode Jabatan</td>
                                <td class="col-2">: {{$stakeholder->MULAI_MENJABAT_P_BARU}} -
                                    {{$stakeholder->AKHIR_MENJABAT_P_BARU}}</td>
                            </tr>
                            <tr>
                        ...
                        <div class="card-footer">
                            <a href="../{{$stakeholder->ID_STAKEHOLDER}}/edit-stakeholder"><button type="button"
                                    class="btn btn-primary">Edit</button></a>
                            <a href="../{{$stakeholder->ID_STAKEHOLDER}}/delete-stakeholder"><button type="button"
                                    class="btn btn-danger"
                                    onclick="return confirm('Yakin akan Dihapus?')">Hapus</button></a>
