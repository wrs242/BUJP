...
<head>
    ...
    <title>Portal Keamanan | Data BUJP</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data BUJP Existing</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><a href="{{ url('entry-bujp') }}"><button type="button"
                                        class="btn btn-block btn-primary">Tambah BUJP</button></a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{$bujp->ID_BUJP}}/kontrak"><button
                                                    class="btn btn-block btn-secondary">Kontrak</button></a>
                                        </td>
                                        @endforeach
                                    </tr>
                            </table>
