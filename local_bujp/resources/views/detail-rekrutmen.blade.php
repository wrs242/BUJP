            ...
            <div class="card card-warning">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img src="../uploads/rekrutmen/foto_kantor/{{$bujp->FOTO_KANTOR}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img src="../uploads/rekrutmen/foto_akta/{{$bujp->FOTO_AKTA}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img src="../uploads/rekrutmen/foto_sio/{{$bujp->FOTO_AKTA}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/bpjs_ketenagakerjaan/{{$bujp->FOTO_BPJS_KETENAGA_KERJAAN}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/bpjs_kesehatan/{{$bujp->FOTO_BPJS_KESEHATAN}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/rekening_koran/{{$bujp->FOTO_REKENING_KORAN}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/pejabat_tni/{{$bujp->FOTO_PEJABAT_TNI}}" width="100%">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label>Foto Pejabat</label>
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/pejabat_polri/{{$bujp->FOTO_PEJABAT_POLRI}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3"><img
                                        src="../uploads/rekrutmen/spt_perusahaan/{{$bujp->SPT_PERUSAHAAN}}"
                                        width="100%"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <a href="../{{$bujp->ID_BUJP}}/edit-rekrutmen"><button type="button"
                                class="btn btn-primary">Edit</button></a>
                        <a href="../{{$bujp->ID_BUJP}}/delete-rekrutmen"><button type="button"
