...
<head>
  ...
  <title>Portal Keamanan | Standarisasi Rekrutmen</title>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <label
                h3 class="card-title">Rekrutmen</h3>
              <label>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <div for="teks">1.BUJP Lulus seleksi company clearence (pengecekan kantor & Legalitas)
                  </div>
                </div>
                <div class="form-group">
                    <div for="teks2">2.Setiap BUJP minimal 2 (dua) orang Direksi wajib memiliki Sertifikat Gada Utama.
                    </div>
                  </div>
                <div class="form-group">
                    <div for="teks3">3.Setiap angggota wajib telah mengikuti pelatihan dasar satpam dan memiliki sertifikat Gada Pratama.
                    </div>
                </div>
                <div class="form-group">
                    <div for="teks3">4.Kepada BUJP yang telah dinyatakan sebagai pemenang tender, untuk anggota yang akan di tugaskan wajib mengikuti pembekalan tentang Product Knowledge, SOP, IK & Obyek Pengamanan
                    </div>
                  </div>
                    <div class="form-group">
                    <div for="teks3">5.Kepada BUJP Peserta tender wajib merumuskan Potensi Ancaman, Tantangan, Hambatan & Gangguan (ATHG), serta merumuskan langkah – langkah penanganan dan penyelesaian.
                    </div>
                  </div>
                <div class="form-group">
                    <div for="teks3">6.Kepada BUJP wajib menempatkan koordinator keamanan dari unsur TNI / POLRI aktif dan 1 orang petugas Administrasi
                    </div>
                  </div>
