...
<head>
  ...
  <title>Portal Keamanan| Standarisasi Proses Tagihan</title>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <label
            h1 class="m-1">Proses Tagihan</h1>
          </label>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <label
                h3 class="card-title">Proses Tagihan</h3>
              <label>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <div for="teks">1.Proses Invoice Dapat Diajukan Bersamaan Dengan Pengajuan Berita Acara Pekerjaan Lengkap Dengan  Lampirannya :
                  </div>
                </div>
                <div class="form-group">
                    <div for="teks2">-Apabila diajukan terpisah dari berita acara, invoice diajukan paling lambat tanggal 10 setiap bulannya
                    </div>
                  </div>
                <div class="form-group">
                    <div for="teks3">-Terdapat koreksi diselesaikan dalam waktu 2 hari, (tanggal 12)
                    </div>
                </div>
                <div class="form-group">
                    <div for="teks3">-Giro/Cek diterima BUJP 14 Hari kerja atau terakhir tanggal 28 setiap bulan.
                    </div>
                  </div>
                    <div class="form-group">
                    <div for="teks3">2.Proses Berita Acara Pekerjaan Dan Tagihan, Pada Lembar Pertama, Harus Ada Formulir Kendali Tagihan Yang Harus Ditandatangani Oleh  Setiap Bagian Sesuai Dengan Prosesnya.
                    </div>
                  </div>
                <div class="form-group">
                    <div for="teks3">3.Realisasi Pembayaran Gaji :
                    </div>
                  </div>
                  <div class="form-group">
                    <div for="teks2">-Diterima anggota  setiap tanggal 3
                    </div>
                  </div>
                  <div class="form-group">
                    <div for="teks2">-Diterima anggota paling lambat tanggal 5
                    </div>
                  </div>
                  <div class="form-group">
                    <div for="teks2">-Diterima diatas tanggal 5, dikenakan Sanksi Denda
                    </div>
                  </div>
