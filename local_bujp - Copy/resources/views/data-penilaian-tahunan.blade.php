...
<head>
  ...
  <title>Portal Keamanan | Data Penilaian Tahunan</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Penilaian Tahunan</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="col-12">
            ...
            <h3 class="card-title"><a href="{{ url('tambah-penilaian-tahunan') }}"><button type="button" class="btn btn-block btn-primary">Tambah Penilaian Tahunan</button></a></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
