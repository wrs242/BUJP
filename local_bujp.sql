...
(7, NULL, 'Pradita University', '0727845245', '2022-06-21', 'Serpong Terrace Blok E.5/1', 'Ya', '2022-06-29', 'asdwds', 'Ya', NULL, '1656402078.png', 'Ya', '2022-06-29', '2022-06-30', '10114410', '1656402078.png', '20144784', '2022-06-29', '1656402078.png', 'Terdaftar', '5242\\', '1656402078.png', 'Terdaftar', '14152', '1656402078.png', '1656402078.png', 2, 'Milik Pribadi', 2, 'Sewa', 'ffdf', 'wdwdw', 'dddd', 'wqqqq', 'wwww', 'abc', 'abc', 'www', 'eee', '1656402078.png', 'fdzwqw', 'qwqwqw', 'qwwqqw', 'sddsds', '1656402078.png', '1656402078.png', 'Lulus', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, '2022-06-29');
...
(2, 5, '25453', NULL, '2022-06-13', '2022-06-30', '1', '1', 'Adendum', 'dadwaw');
...
CREATE TABLE `pedoman_keamanan` (
  `ID_PEDOMAN` int(10) NOT NULL,
  `FILE_PEDOMAN` char(100) DEFAULT NULL,
  `USER_MODIFIED` int(10) DEFAULT NULL,
  `DATE_MODIFIED` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `pedoman_keamanan`
--

INSERT INTO `pedoman_keamanan` (`ID_PEDOMAN`, `FILE_PEDOMAN`, `USER_MODIFIED`, `DATE_MODIFIED`) VALUES
(6, 'standarisasi_kompetensi.pdf', 8, '2022-06-30');
...
(10, 'Summarecon Kelapa Gading', 'wdwdwd', 'POLRI', 'wwwwwwww', 'Serpong Terrace Blok E.5/1', 'wdasw', 'sdwd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'wdwaswdwd', 'wdasw', '2022-07-19', '2022-06-27', '5', NULL, 'wdas', 'wdws', '1656948899.jpg', 8, '2022-07-04', NULL, NULL);
...
--
ALTER TABLE `bujp`
  MODIFY `ID_BUJP` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `kontrak`
  MODIFY `ID_KONTRAK` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `pedoman_keamanan`
--
ALTER TABLE `pedoman_keamanan`
  MODIFY `ID_PEDOMAN` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `stakeholder`
  MODIFY `ID_STAKEHOLDER` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
ALTER TABLE `bujp`
  ...
  ADD CONSTRAINT `bujp_ibfk_4` FOREIGN KEY (`USER_CREATED`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `bujp_ibfk_5` FOREIGN KEY (`USER_MODIFIED`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `pedoman_keamanan`
  ADD CONSTRAINT `pedoman_keamanan_ibfk_1` FOREIGN KEY (`USER_MODIFIED`) REFERENCES `users` (`id`);
